...
**On a similar basis, we could also look at differing age groups or genders within the data set and work out if certain groups are more likely to hire bikes at certain times.**

###**Part 2**

Let's try and plot the all the different start and see if this gives us any further insight in terms of some of the groupings we've been looking at.
