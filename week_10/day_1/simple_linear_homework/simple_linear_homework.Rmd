...
**Interpretation**: *The r_squared value reported is 0.6474772 meaning that the model suggests that around 64.75% of the variation in actual length is predictable from the expected length. This is not an exceptional high percentage but it is above 50% which is apparently quite good when trying to predict human behavior.*
